...
# from ..app import HistoricalValidationToolPeru
    ...
    4. Enter tethys test command.
       ...
       See below for specific examples
        ...
        To run all tests across this app:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_peru"

        To run all tests in this file:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_peru.tests.tests"

        To run tests in the HistoricalValidationToolPeruTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_peru.tests.tests.HistoricalValidationToolPeruTestCase"

        To run only the test_if_tethys_platform_is_great function in the HistoricalValidationToolPeruTestCase class:
            Test command: "tethys test -f tethys_apps.tethysapp.historical_validation_tool_peru.tests.tests.HistoricalValidationToolPeruTestCase.test_if_tethys_platform_is_great"
